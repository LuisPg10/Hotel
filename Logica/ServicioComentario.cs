...
namespace Logica
{
    public class ServicioComentario
    {
        ...
        public void RegistrarHabitacion(Comentario comentario)
        {
            try
            {
        ...
        public Comentario consultarHabitacion(int id)
        {
            ...
            try
            {
                ...
                while (consulta.Read())
                {
                    if (consulta.GetUInt32(0) == id)
                    {
                        ...
                        comentario.Usuario = new ServicioUsuario().consultarUsuario(consulta.GetInt32(1));
                        comentario.Habitacion = new ServicioHabitacion().consultarHabitacion(consulta.GetInt32(1));
